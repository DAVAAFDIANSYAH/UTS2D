...
<head>    
    ...
    ?>
    <div class="container">
        <div id="jdlaccr" style="font-size:36px;color:brown;">Harber Web</
        <div class="card shadow-sm mb-5 bg-black rounded">
            <div class="card body">
            <h5 class="card-title">input name:</h5>
            <p class="card-text"><input type="text" class="input input-1g" style="width:100%;" id="srchInv"></p>
            <div>
            <div class="card-footer">
                <button class="btn btn-primary" id="btnsearch">Submit</<button>
            <div>
     </div>
        <div id="infoinvaaccI"></div>
    </div>    
    <html>
